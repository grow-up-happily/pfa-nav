...
#include "rmoss_interfaces/srv/detail/get_camera_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmoss_interfaces::srv::GetCameraInfo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmoss_interfaces::srv::GetCameraInfo_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces::srv::GetCameraInfo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rmoss_interfaces::srv::GetCameraInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmoss_interfaces::srv::GetCameraInfo_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<rmoss_interfaces::srv::GetCameraInfo_Request>()
{
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmoss_interfaces, srv, GetCameraInfo_Request)() {
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rmoss_interfaces
cdr_serialize(
  const rmoss_interfaces::srv::GetCameraInfo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: camera_info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmoss_interfaces::srv::GetCameraInfo_Response & ros_message)
{
  // Member: camera_info
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rmoss_interfaces::srv::GetCameraInfo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rmoss_interfaces::srv::GetCameraInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rmoss_interfaces::srv::GetCameraInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_rmoss_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<rmoss_interfaces::srv::GetCameraInfo_Response>()
{
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmoss_interfaces, srv, GetCameraInfo_Response)() {
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo_Response__handle;
}
...
get_service_type_support_handle<rmoss_interfaces::srv::GetCameraInfo>()
{
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmoss_interfaces, srv, GetCameraInfo)() {
  return &rmoss_interfaces::srv::typesupport_fastrtps_cpp::_GetCameraInfo__handle;
}
