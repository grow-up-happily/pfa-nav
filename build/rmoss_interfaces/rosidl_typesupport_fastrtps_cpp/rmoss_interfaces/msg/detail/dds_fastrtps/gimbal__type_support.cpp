...
#include "rmoss_interfaces/msg/detail/gimbal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rmoss_interfaces::msg::Gimbal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rmoss_interfaces::msg::Gimbal & ros_message)
{
  // Member: yaw
  cdr >> ros_message.yaw;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rmoss_interfaces::msg::Gimbal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rmoss_interfaces::msg::Gimbal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmoss_interfaces::msg::Gimbal *>(
    untyped_ros_message);
...
get_message_type_support_handle<rmoss_interfaces::msg::Gimbal>()
{
  return &rmoss_interfaces::msg::typesupport_fastrtps_cpp::_Gimbal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmoss_interfaces, msg, Gimbal)() {
  return &rmoss_interfaces::msg::typesupport_fastrtps_cpp::_Gimbal__handle;
}
