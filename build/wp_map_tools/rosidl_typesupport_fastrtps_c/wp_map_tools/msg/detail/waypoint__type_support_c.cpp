...
#include "wp_map_tools/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // frame_id, name
#include "rosidl_runtime_c/string_functions.h"  // frame_id, name
...
using _Waypoint__ros_msg_type = wp_map_tools__msg__Waypoint;
...
size_t get_serialized_size_wp_map_tools__msg__Waypoint(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Waypoint__ros_msg_type * ros_message = static_cast<const _Waypoint__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_wp_map_tools__msg__Waypoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_wp_map_tools
size_t max_serialized_size_wp_map_tools__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wp_map_tools__msg__Waypoint;
    is_plain =
      (
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_wp_map_tools__msg__Waypoint(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wp_map_tools, msg, Waypoint)() {
