...
{
  new (message_memory) wp_map_tools::msg::Waypoint(_init);
}

void Waypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wp_map_tools::msg::Waypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoint_message_member_array[3] = {
  {
    ...
    offsetof(wp_map_tools::msg::Waypoint, frame_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wp_map_tools::msg::Waypoint, name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wp_map_tools::msg::Waypoint, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoint_message_members = {
  "wp_map_tools::msg",  // message namespace
  "Waypoint",  // message name
  3,  // number of fields
  sizeof(wp_map_tools::msg::Waypoint),
...
{
  return &::wp_map_tools::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wp_map_tools, msg, Waypoint)() {
  return &::wp_map_tools::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
