...
: ${AMENT_CURRENT_PREFIX:="/home/yy/sight/pfa-nav/install/pointcloud_to_laserscan"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pointcloud_to_laserscan/environment/library_path.sh"
